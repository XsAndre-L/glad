...
export const build = (cwd: string = process.cwd()): BuildType => {
  ...
  return {
    type: "architectures",
    windows_x86_64: {
      configStep: `cmake -S ./cmake -B build/windows/x86_64 -G Ninja \
      ...
      -DCMAKE_INSTALL_PREFIX=${OUTPUT_DIR}/windows/x86_64/glad
    `,
    ...
    windows_aarch64: {
      configStep: `cmake -S ./cmake -B build/windows/aarch64 -G Ninja \
      -DCMAKE_BUILD_TYPE=Release \
      -DBUILD_SHARED_LIBS=OFF \
      -DCMAKE_C_COMPILER=${CLANG} \
      -DCMAKE_CXX_COMPILER=${CLANGXX} \
      ...
      -DCMAKE_INSTALL_PREFIX=${OUTPUT_DIR}/windows/aarch64/glad
      `,
